...
function(add_pretty_parser TARGET)
    ...
    if(OPTIONS_C)
        add_library(sourcepp_${TARGET}c SHARED ${${PROJECT_NAME}c_SOURCES} ${OPTIONS_PRECOMPILED_HEADERS} ${OPTIONS_SOURCES} "$<$<BOOL:${WIN32}>:${CMAKE_CURRENT_SOURCE_DIR}/branding/logo.rc>")
