...
function(add_pretty_parser TARGET)
    ...
    if(OPTIONS_C)
        ...
        if(TARGET ${PROJECT_NAME}_cwrap)
            target_compile_definitions(${PROJECT_NAME}_cwrap PRIVATE -D${TARGET_UPPER}_PATH="${CMAKE_CURRENT_SOURCE_DIR}/lang/c/include/${TARGET}c")
            target_link_libraries(${PROJECT_NAME}_cwrap PRIVATE sourcepp_${TARGET}c)
        endif()
