...
function(add_sourcepp_library TARGET)
    ...
    if(SOURCEPP_USE_${TARGET_UPPER})
        ...
        if(SOURCEPP_BUILD_CSHARP_WRAPPERS AND OPTIONS_CSHARP)
            add_dependencies(sourcepp_csharp sourcepp::${TARGET}c)
            add_custom_command(TARGET sourcepp::${TARGET}c POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy "${CMAKE_BINARY_DIR}/sourcepp_${TARGET}c${CMAKE_SHARED_LIBRARY_SUFFIX}" "${CMAKE_CURRENT_SOURCE_DIR}/lang/csharp/src")
        endif()
