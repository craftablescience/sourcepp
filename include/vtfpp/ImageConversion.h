...
VTFPP_FORMAT_INHERITED(BGRX8888_LINEAR, BGRX8888);

VTFPP_FORMAT_INHERITED(RGBA8888_LINEAR, RGBA8888);

VTFPP_FORMAT_INHERITED(ABGR8888_LINEAR, ABGR8888);

VTFPP_FORMAT_INHERITED(ARGB8888_LINEAR, ARGB8888);

VTFPP_FORMAT_INHERITED(BGRA8888_LINEAR, BGRA8888);

VTFPP_FORMAT_INHERITED(RGB888_LINEAR, RGB888);

VTFPP_FORMAT_INHERITED(BGR888_LINEAR, BGR888);

VTFPP_FORMAT_INHERITED(BGRX5551_LINEAR, BGRX5551);

VTFPP_FORMAT_INHERITED(I8_LINEAR, I8);

VTFPP_FORMAT_INHERITED(RGBA16161616_LINEAR, RGBA16161616);

VTFPP_FORMAT_INHERITED(BGRX8888_LE, BGRX8888);

VTFPP_FORMAT_INHERITED(BGRA8888_LE, BGRA8888);
...
concept PixelType =
		...
		std::same_as<T, R16F> ||
		std::same_as<T, BGRX8888_LINEAR> ||
		std::same_as<T, RGBA8888_LINEAR> ||
		std::same_as<T, ABGR8888_LINEAR> ||
		std::same_as<T, ARGB8888_LINEAR> ||
		std::same_as<T, BGRA8888_LINEAR> ||
		std::same_as<T, RGB888_LINEAR> ||
		std::same_as<T, BGR888_LINEAR> ||
		std::same_as<T, BGRX5551_LINEAR> ||
		std::same_as<T, I8_LINEAR> ||
		std::same_as<T, RGBA16161616_LINEAR> ||
		std::same_as<T, BGRX8888_LE> ||
		std::same_as<T, BGRA8888_LE> ||
		std::same_as<T, R8>;
