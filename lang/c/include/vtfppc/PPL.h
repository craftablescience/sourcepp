...
SOURCEPP_API const unsigned char* vtfpp_ppl_get_image_raw(vtfpp_ppl_handle_t handle, size_t* imageLen, uint32_t* width, uint32_t* height, uint32_t lod); // REQUIRES MANUAL FREE: sourcepp_buffer_free
