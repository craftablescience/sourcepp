...
VTFPP_API vtfpp_psframes_handle_t vtfpp_psframes_open_from_mem(const unsigned char* buffer, size_t bufferLen) {
...
VTFPP_API vtfpp_psframes_handle_t vtfpp_psframes_open_from_file(const char* psframesPath) {
...
VTFPP_API sourcepp_buffer_t vtfpp_psframes_get_image_data_as_bgr888(vtfpp_psframes_handle_t handle, uint32_t frame) {
	SOURCEPP_EARLY_RETURN_VAL(handle, SOURCEPP_BUFFER_INVALID);
