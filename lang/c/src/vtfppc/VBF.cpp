...
VTFPP_API vtfpp_vbf_handle_t vtfpp_vbf_open_from_mem(const unsigned char* buffer, size_t bufferLen) {
...
VTFPP_API vtfpp_vbf_handle_t vtfpp_vbf_open_from_file(const char* vbfPath) {
