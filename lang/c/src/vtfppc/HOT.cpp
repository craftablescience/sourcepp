...
VTFPP_API vtfpp_hot_handle_t vtfpp_hot_create() {
	return new HOT{};
}

VTFPP_API vtfpp_hot_handle_t vtfpp_hot_open_from_mem(const unsigned char* hotData, size_t hotLen) {
...
VTFPP_API vtfpp_hot_handle_t vtfpp_hot_open_from_file(const char* hotPath) {
...
VTFPP_API sourcepp_buffer_t vtfpp_hot_bake(vtfpp_hot_handle_t handle) {
