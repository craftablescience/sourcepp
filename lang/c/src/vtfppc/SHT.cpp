...
VTFPP_API vtfpp_sht_handle_t vtfpp_sht_create() {
	return new SHT{};
}

VTFPP_API vtfpp_sht_handle_t vtfpp_sht_open_from_mem(const unsigned char* shtData, size_t shtLen) {
...
VTFPP_API vtfpp_sht_handle_t vtfpp_sht_open_from_file(const char* shtPath) {
...
VTFPP_API sourcepp_buffer_t vtfpp_sht_bake(vtfpp_sht_handle_t handle) {
