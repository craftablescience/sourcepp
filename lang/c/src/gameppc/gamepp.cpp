...
GAMEPP_API gamepp_game_instance_handle_t gamepp_game_instance_find() {
...
GAMEPP_API gamepp_game_instance_handle_t gamepp_game_instance_find_with_name(const char* windowNameOverride) {
...
GAMEPP_API sourcepp_string_t gamepp_game_instance_get_window_title(gamepp_game_instance_handle_t handle) {
