...
VPKPP_API vpkpp_pack_file_handle_t vpkpp_apk_create(const char* path) {
...
VPKPP_API vpkpp_pack_file_handle_t vpkpp_apk_open(const char* path, vpkpp_entry_callback_t callback) {
	SOURCEPP_EARLY_RETURN_VAL(path, nullptr);
