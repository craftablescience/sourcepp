...
internal static partial class DLL
{
	...
	[LibraryImport(Name, StringMarshalling = StringMarshalling.Utf8)]
	public static partial int vtfpp_vtf_set_image_from_file(nint handle, string imagePath, ImageConversion.ResizeFilter filter, byte mip, ushort frame, byte face, ushort slice, float quality);
