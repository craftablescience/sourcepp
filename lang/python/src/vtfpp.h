...
inline void register_python(py::module_& m) {
	...
	py::enum_<ImageFormat>(vtfpp, "ImageFormat")
		...
		.value("STRATA_BC6H_SF",                    ImageFormat::STRATA_BC6H_SF)
		.value("STRATA_BC6H_UF",                    ImageFormat::STRATA_BC6H_UF)
	...
	py::enum_<Resource::Type>(cResource, "Type")
		...
		.value("PARALLAX_CORRECTED_CUBEMAP", Resource::TYPE_PARALLAX_CORRECTED_CUBEMAP)
	...
	py::class_<Resource::PCC>(cResource, "PCC")
		.def(py::init())
		.def_rw("origin",           &Resource::PCC::origin)
		.def_rw("inverseTransform", &Resource::PCC::inverseTransform);
	...
	cResource
		...
		.def("get_data_as_parallax_corrected_cubemap", &Resource::getDataAsParallaxCorrectedCubemap)
	...
	py::enum_<VTF::Flags>(cVTF, "Flags", py::is_flag())
		...
		.value("V0_LOAD_SMALL_MIPS",                              VTF::FLAG_V0_LOAD_SMALL_MIPS)
		...
		.value("V3_LOAD_ALL_MIPS",                                VTF::FLAG_V3_LOAD_ALL_MIPS)
	...
	cVTF
		...
		.def_prop_ro("depth", [](const VTF& self) { return self.getDepth(); })
		.def("depth_for_mip", [](const VTF& self, uint8_t mip = 0) { return self.getDepth(mip); }, "mip"_a = 0)
		...
		.def("set_parallax_corrected_cubemap_resource", &VTF::setParallaxCorrectedCubemapResource, "value"_a)
		.def("remove_parallax_corrected_cubemap_resource", &VTF::removeParallaxCorrectedCubemapResource)
