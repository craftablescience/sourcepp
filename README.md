...
<table>
  ...
  <tr><!-- empty row to disable GitHub striped bg color --></tr>
  <tr>
    <td rowspan="39"><code>vtfpp</code></td>
  ...
  <tr><!-- empty row to disable GitHub striped bg color --></tr>
  <tr>
    <td><a href="https://jpeg.org/jpegxl" target="_blank" rel="noreferrer">JXL</a></td>
    <td align="center">✅</td>
    <td align="center">✅</td>
  </tr>
  <tr><!-- empty row to disable GitHub striped bg color --></tr>
...
- [WifeRadiant](https://github.com/erysdren/WifeRadiant): The open-source, cross-platform level editor for idTech, Source Engine, and GoldSrc based games.
