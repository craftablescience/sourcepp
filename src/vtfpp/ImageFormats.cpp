...
bool ImageFormatDetails::compressed(ImageFormat format) {
	return red(format) == -1;
}

int8_t ImageFormatDetails::red(ImageFormat format) {
	switch (format) {
...
int8_t ImageFormatDetails::green(ImageFormat format) {
	switch (format) {
		case ImageFormat::RGB323232F:
		case ImageFormat::RGBA32323232F:
			return 32;
...
int8_t ImageFormatDetails::blue(ImageFormat format) {
	switch (format) {
		case ImageFormat::RGB323232F:
		case ImageFormat::RGBA32323232F:
			return 32;
...
int8_t ImageFormatDetails::alpha(ImageFormat format) {
	switch (format) {
		case ImageFormat::RGBA32323232F:
			return 32;
		case ImageFormat::RGBA16161616F:
