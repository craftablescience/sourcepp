...
if(SOURCEPP_VTFPP_BUILD_WITH_COMPRESSONATOR)
    target_link_libraries(sourcepp_vtfpp PRIVATE CMP_Compressonator)
    target_compile_definitions(sourcepp_vtfpp PUBLIC VTFPP_BUILD_WITH_COMPRESSONATOR)
endif()
...
if(SOURCEPP_VTFPP_SUPPORT_JXL)
    target_link_libraries(sourcepp_vtfpp PRIVATE jxl)
    if(SOURCEPP_BUILD_WITH_THREADS)
        target_link_libraries(sourcepp_vtfpp PRIVATE jxl_threads)
    endif()
    target_compile_definitions(sourcepp_vtfpp PUBLIC VTFPP_SUPPORT_JXL)
endif()
