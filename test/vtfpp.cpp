...
TEST(vtfpp, write_non_po2) {
	...
	EXPECT_EQ(vtf.getDepth(), 1);
	EXPECT_EQ(vtf.getStartFrame(), 0);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[0], 0.073863618f);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[1], 0.046342254f);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[2], 0.26251888f);
	EXPECT_FLOAT_EQ(vtf.getBumpMapScale(), 1.f);
	EXPECT_EQ(vtf.getThumbnailFormat(), ImageFormat::DXT1);
	EXPECT_EQ(vtf.getThumbnailWidth(), 16);
	EXPECT_EQ(vtf.getThumbnailHeight(), 16);
...
TEST(vtfpp, write_v70) {
	...
	EXPECT_EQ(vtf.getDepth(), 1);
	EXPECT_EQ(vtf.getStartFrame(), 0);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[0], 0.52724671f);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[1], 0.46667075f);
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[2], 0.38884577f);
	EXPECT_FLOAT_EQ(vtf.getBumpMapScale(), 1.f);
	EXPECT_EQ(vtf.getThumbnailFormat(), ImageFormat::DXT1);
	EXPECT_EQ(vtf.getThumbnailWidth(), 16);
	EXPECT_EQ(vtf.getThumbnailHeight(), 16);
...
TEST(vtfpp, read_xbox_p8_animated) {
	...
	EXPECT_FLOAT_EQ(vtf.getReflectivity()[2], 0.25731158f);
	EXPECT_FLOAT_EQ(vtf.getBumpMapScale(), 1.f);
	EXPECT_EQ(vtf.getThumbnailFormat(), ImageFormat::RGB888);
	EXPECT_EQ(vtf.getThumbnailWidth(), 1);
	EXPECT_EQ(vtf.getThumbnailHeight(), 1);
